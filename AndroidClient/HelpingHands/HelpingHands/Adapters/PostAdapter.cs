...
namespace HelpingHands.Adapters
{
    internal class PostAdapter : ListAdapter<PostDTO>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.Text1).Text = AutoEllipsis(item.IdUser.ToString(), 25);
            ...
            view.FindViewById<TextView>(Resource.Id.Text5).Text = AutoEllipsis(item.Eveniment.Name, 40);
